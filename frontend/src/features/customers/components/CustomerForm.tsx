...
export function CustomerForm({ onSubmit, onCancel, mode, initialValues, submitError }: CustomerFormProps) {
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
      ...
      <FormField error={errors.address?.message} label="Địa chỉ" required>
