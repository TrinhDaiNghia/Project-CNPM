...
('eeeeeeee-eeee-eeee-eeee-eeeeeeeee001', 'Bảo trì định kỳ', '2026-03-15 08:00:00', '2026-03-18 17:00:00',
 'PENDING', 'Chờ tiếp nhận', 1, '44444444-4444-4444-4444-444444444001', '11111111-1111-1111-1111-111111111101', '11111111-1111-1111-1111-111111111301'),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeee002', 'Lỗi kim giây', '2026-03-15 09:00:00', '2026-03-19 17:00:00',
 'IN_PROGRESS', 'Đang thay linh kiện', 1, '44444444-4444-4444-4444-444444444002', '11111111-1111-1111-1111-111111111102', '11111111-1111-1111-1111-111111111301');
...
-- =========================================================
-- 15) INVENTORIES (gốc: 2 → thêm 8 → tổng 10)
-- =========================================================
INSERT INTO inventories (
    id, issue_description, received_date, expected_return_date,
    status, tech_notes, quantity, product_id, customer_id, owner_id
) VALUES
      ('eeeeeeee-eeee-eeee-eeee-eeeeeeeee003', 'Kiểm tra chống nước',  '2026-03-16 08:00:00', '2026-03-19 17:00:00',
       'PENDING',     'Chờ xử lý',          1, '44444444-4444-4444-4444-444444444003', '11111111-1111-1111-1111-111111111103', '11111111-1111-1111-1111-111111111302'),

      ('eeeeeeee-eeee-eeee-eeee-eeeeeeeee004', 'Thay pin mới',         '2026-03-16 09:30:00', '2026-03-17 17:00:00',
       'CLOSED',      'Đã thay pin',        1, '44444444-4444-4444-4444-444444444005', '11111111-1111-1111-1111-111111111104', '11111111-1111-1111-1111-111111111302'),

      ('eeeeeeee-eeee-eeee-eeee-eeeeeeeee005', 'Nâng cấp phần mềm',    '2026-03-17 08:00:00', '2026-03-18 17:00:00',
       'IN_PROGRESS',  'Đang cập nhật',     1, '44444444-4444-4444-4444-444444444006', '11111111-1111-1111-1111-111111111105', '11111111-1111-1111-1111-111111111302'),

      ('eeeeeeee-eeee-eeee-eeee-eeeeeeeee006', 'Vệ sinh bộ máy',       '2026-03-17 10:00:00', '2026-03-20 17:00:00',
       'PENDING',      'Chờ tiếp nhận',     1, '44444444-4444-4444-4444-444444444007', '11111111-1111-1111-1111-111111111106', '11111111-1111-1111-1111-111111111302'),

      ('eeeeeeee-eeee-eeee-eeee-eeeeeeeee007', 'Đánh bóng niềng',      '2026-03-18 08:00:00', '2026-03-21 17:00:00',
       'IN_PROGRESS',  'Đang xử lý',        1, '44444444-4444-4444-4444-444444444008', '11111111-1111-1111-1111-111111111107', '11111111-1111-1111-1111-111111111302'),

      ('eeeeeeee-eeee-eeee-eeee-eeeeeeeee008', 'Bảo trì định kỳ',      '2026-03-19 08:00:00', '2026-03-22 17:00:00',
       'CLOSED',       'Hoàn thành',        1, '44444444-4444-4444-4444-444444444009', '11111111-1111-1111-1111-111111111108', '11111111-1111-1111-1111-111111111302'),

      ('eeeeeeee-eeee-eeee-eeee-eeeeeeeee009', 'Thay dây đồng hồ',     '2026-03-20 09:00:00', '2026-03-23 17:00:00',
       'PENDING',      'Chờ linh kiện',     1, '44444444-4444-4444-4444-444444444010', '11111111-1111-1111-1111-111111111101', '11111111-1111-1111-1111-111111111302'),

      ('eeeeeeee-eeee-eeee-eeee-eeeeeeeee010', 'Sửa lỗi cảm ứng',      '2026-03-21 08:00:00', '2026-03-25 17:00:00',
       'IN_PROGRESS',  'Đang kiểm tra PCB', 1, '44444444-4444-4444-4444-444444444011', '11111111-1111-1111-1111-111111111102', '11111111-1111-1111-1111-111111111302');
